...
export const direccionEjecutiva: Miembro[] = [
    { id: 1, nombre: "Cristian Suárez", cargo: "Presidente ejecutivo", img: "https://res.cloudinary.com/dlipwrbvd/image/upload/v1773350784/Dise%C3%B1o_sin_t%C3%ADtulo_10_ojudv4.png", alt: "Cristian Suárez cofundador y Presidente Ejecutivo de HiveYoung", descripcion: "Cofundador de HiveYoung, emprendedor, apasionado por el emprendimiento y la tecnología.", linkedin: "https://linkedin.com/" },
    { id: 4, nombre: "Alessandra Mussuto", cargo: "Directora Ejecutiva", img: "https://res.cloudinary.com/dlipwrbvd/image/upload/v1773350774/Dise%C3%B1o_sin_t%C3%ADtulo_11_vybqch.png", alt: "Alessandra Mussuto directora ejecutiva de HiveYoung", descripcion: "Estudiante de Ingeniería Comercial en la Universidad de Chile. Apasionada por las artes escénicas.", linkedin: "https://linkedin.com/" },
    ...
    { id: 7, nombre: "Martina Ortega", cargo: "Directora de Marketing", img: "https://res.cloudinary.com/dlipwrbvd/image/upload/v1773016989/WhatsApp_Image_2026-02-18_at_14.01.34_kndbdk.jpg", alt: "Martina Ortega Directora de Marketing de HiveYoung", descripcion: "Estudiante del Instituto Nacional, me apasiona la ciencia y participo en movimientos femeninos como Tremendas y Lumina", linkedin: "https://linkedin.com/" },
];
